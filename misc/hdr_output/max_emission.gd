...
# Set this to your desired BaseMaterial3D emission color.
@export var sdr_emission: Color = Color.WHITE
...
func _process(_delta: float) -> void:
	...
	var linear_color = sdr_emission.srgb_to_linear()

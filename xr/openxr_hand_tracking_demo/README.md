...
> Note: The trackers used for the hand tracking API are `/user/hand_tracker/left` and `/user/hand_tracker/right`.

> Note: There are new project settings in Godot 4.4 that are not enabled by default and effect this demo.

...
func _ready():
	...
	$ButtonSave.connect("pressed", Callable(self, "button_pressed").bind("save_picture"))
	...
	$ButtonToolPencil.connect("pressed", Callable(self, "button_pressed").bind("mode_pencil"))
	$ButtonToolEraser.connect("pressed", Callable(self, "button_pressed").bind("mode_eraser"))
	$ButtonToolRectangle.connect("pressed", Callable(self, "button_pressed").bind("mode_rectangle"))
	$ButtonToolCircle.connect("pressed", Callable(self, "button_pressed").bind("mode_circle"))
	$BrushSettings/ButtonShapeBox.connect("pressed", Callable(self, "button_pressed").bind("shape_rectangle"))
	$BrushSettings/ButtonShapeCircle.connect("pressed", Callable(self, "button_pressed").bind("shape_circle"))
	...
	$ColorPickerBackground.connect("color_changed", Callable(self, "background_color_changed"))
	$BrushSettings/HScrollBarBrushSize.connect("value_changed", Callable(self, "brush_size_changed"))

...
public partial class CubeMath : Node3D
{
    ...
    public override void _Process(double delta)
    {
        ...
        if (_isParentReady)
        {
            RotateX(deltaf * (Input.GetActionStrength("move_back") - Input.GetActionStrength("move_forward")));
            RotateY(deltaf * (Input.GetActionStrength("move_right") - Input.GetActionStrength("move_left")));
            RotateZ(deltaf * (Input.GetActionStrength("move_counterclockwise") - Input.GetActionStrength("move_clockwise")));
